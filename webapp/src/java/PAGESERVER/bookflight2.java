 ...
 * @author POUSHALI
 */
public class bookflight2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet bookflight2</title>");            
            out.println("</head>");
            out.println("<body>");
//            out.println("<h1>Servlet bookflight2 at " + request.getContextPath() + "</h1>");
                ...
                vDEPARTUREDATE=request.getParameter("date");
...
//                    
                ...
                Logger.getLogger(bookflight2.class.getName()).log(Level.SEVERE, null, ex);
            }
